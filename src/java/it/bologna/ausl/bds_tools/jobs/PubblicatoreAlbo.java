...
//    }
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        log.info("Pubblicatore Albo Started");
...
//            return;
        ...
        try {
            ...
            log.info("connessione db ottenuta");

            dbConn.setAutoCommit(false);
            log.info("autoCommit settato a: " + dbConn.getAutoCommit());
...
//                    }
            ...
            log.info("Pubblicatore Albo Ended");
        }
    }
    ...
    private void pubblicaSuBalboAndUpdatePubbIoda(Connection dbConn, GdDoc gddoc, List<SottoDocumento> sottodocumenti, Registro registroGddoc, PubblicazioneIoda pubbIoda) throws NamingException, ServletException, SQLException {
        log.info("crezione pubblicazione per balbo...");
        ...
        /* 
                    ...
                    if (stampeUniche.stream().anyMatch(s -> s.getTipo().equals("stampa_unica_omissis"))) {
                        ...
                        if (stampaUnicaOmissis != null) {
                            log.info("aggiunta allegato dal sottodocumento: " + stampaUnicaOmissis.toString());
                    ...
                    // non c'è la stampa unica omissis, per cui prendo quella normale
                        ...
                        if (stampaUnica != null) {
                            log.info("aggiunta allegato dal sottodocumento: " + stampaUnica.toString());
         ...
         */
        log.info("pubblicazione balbo: " + pubblicazione.toString());
