...
public class VersatoreParer implements Job {
     ...
     * perchè chiamato dallo schedulatore o perchè è stata fatta una richiesta
     * "a volere". Dopo i controlli ci accesso il metodo doJob(...) si
     * incaricherà di gestire l'invio del/i documento/i al ParER.
     *
...
//            }
     ...
     *
     * @param context
     * @return true: se servizio è stato richiesto "a volere" false: se servizio
     * è stato richiesto dallo schedulatore
     */
...
//        }
    ...
    /**
     * A partire dal GdDoc costruisce i Params per il mestiere che si occuperà
...
//            per la delibera è la data della prima pubblicazione (indipendentemente dalla sua esecutività)
     ...
     * concordata con il ParER per indicare il tipo dell'unità documentaria
     *
     * @param gddoc
     * @param key
     ...
     * segnaposti nei dati specifici. Se tutto è ok allora il gddoc è pronto per
     * essere versato
     *
     * @param gddoc
     * @return
...
//                    }
     ...
     * orodine cronologico) indipendentemente dall'esecutività se
     * prendiPrimaEsecutiva = TRUE: estrae la prima pubblicazione (in orodine
     * cronologico) dove esecutività = ESECUTIVA
     *
     * @param pubblicazioni
    ...
    /**
     * Controlla che il servizio non sia stato già eseguito oggi. Per farlo
     * legge la data di fine dalla tabella bds_tools.servizi
     *
     * @param dbConn
     * @return "true" se il servizio non è stato eseguito oggi, "false"
     * altrimenti
     * @throws SQLException
     */
...
//                    }
     ...
     *
     * @return "true" se l'ora è maggiore di quella su cron (a ora uguale si
...
//    }
    /**
     * Controlla se i servizi attivi del calcolo idoneità pro parer abbiano
     * finito
     *
     * @param dbConn
     ...
     * inizia a girare sarà settata la data di inizio a now() e la data fine a
     ...
     * dell'ultimo versamento e li inserisce in questa tabella che sarà
